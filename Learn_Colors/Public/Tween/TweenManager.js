...
var lastKnownColor = "red";
function getColor(tweenObject, tweenName) {
    lastKnownColor = findTween(tweenObject, tweenName).api.tweenColor;
    return lastKnownColor;
}

function getLastKnownColor() {
    return lastKnownColor;
}

// Register global helper functions
global.tweenManager = {};
global.tweenManager.getColor = getColor;
global.tweenManager.getLastKnownColor = getLastKnownColor;
